...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_uuid_version6_fromBytes, 0, 1, Identifier\\Uuid\\Version6, 0)
    ZEND_ARG_TYPE_INFO(0, bytes, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_uuid_version6_fromHex, 0, 1, Identifier\\Uuid\\Version6, 0)
...
void php_identifier_uuid_version6_register_class(void)
{
    ...
    INIT_NS_CLASS_ENTRY(ce, "Identifier\\Uuid", "Version6", php_identifier_uuid_version6_methods);
