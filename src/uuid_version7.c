...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_uuid_version7_fromBytes, 0, 1, Identifier\\Uuid\\Version7, 0)
    ZEND_ARG_TYPE_INFO(0, bytes, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_uuid_version7_fromHex, 0, 1, Identifier\\Uuid\\Version7, 0)
...
void php_identifier_uuid_version7_register_class(void)
{
    ...
    INIT_NS_CLASS_ENTRY(ce, "Identifier\\Uuid", "Version7", php_identifier_uuid_version7_methods);
