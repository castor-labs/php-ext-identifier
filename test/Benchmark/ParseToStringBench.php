...
final class ParseToStringBench
{
    ...
    {
        ExtensionUuidV4::fromString(self::UUID_V4)->toString();
    }

    #[Bench]
    public function symfony_uuid_v4(): void
    {
        SymfonyUuid::fromString(self::UUID_V4)->toRfc4122();
    }

    #[Bench]
    public function ramsey_uuid_v4(): void
    {
        RamseyUuid::fromString(self::UUID_V4)->toString();
    }

    #[Bench]
    public function extension_uuid_v7(): void
    {
        ExtensionUuidV7::fromString(self::UUID_V7)->toString();
    }

    #[Bench]
    public function symfony_uuid_v7(): void
    {
        SymfonyUuid::fromString(self::UUID_V7)->toRfc4122();
    }

    #[Bench]
    public function ramsey_uuid_v7(): void
    {
        RamseyUuid::fromString(self::UUID_V7)->toString();
    }

    #[Bench]
    public function extension_ulid(): void
    {
        ExtensionUlid::fromString(self::ULID)->toString();
    }

    #[Bench]
    public function symfony_ulid(): void
    {
        SymfonyUlid::fromString(self::ULID)->toBase32();
    }
}
